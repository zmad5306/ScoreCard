...
This example is a JMS based example of a bank transfer. It includes processing a bank trasfer from oue account to antoher. I also includes handling exception cases such as the NSF, Debit Account Not Exsting and Credit Account not existing. When one of these exceptions occurs it utilzes the Score Card model to detect the failure and correct it.